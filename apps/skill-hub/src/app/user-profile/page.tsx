...
import { CircleUser, Heart, LogOut, Mail, MapPin, MessageSquare, Phone, Save, User } from 'lucide-react';
          ...
          <div className="flex-1 text-center md:text-left text-white md:text-gray-800">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4">
              ...
              <div
                ...
                className={`cursor-pointer p-3 rounded-xl shadow-sm border flex items-center gap-4 min-w-[180px] transition-all ${activeTab === 'Миний хадгалсан' ? 'bg-orange-50 border-orange-600' : 'bg-white border-gray-100'}`}
              >
            ...
            {activeTab === 'Хувийн мэдээлэл' ? (
              ...
              <div className="flex flex-col items-center justify-center py-20 text-gray-400">
                <div className="bg-gray-50 p-6 rounded-full mb-4">
                  ...
                  {activeTab === 'Миний хадгалсан' && <Heart size={48} />}

      ...
      <div className={`fixed left-0 top-0 h-screen bg-white/5 z-20 transition-all duration-300 ${sidebarOpen ? 'w-85' : 'w-0 pointer-events-none'}`}>
        ...
        <div className="p-5 pl-7 border-b border-t flex justify-between items-center">
          <p className="font-bold cursor-default">
            ...
            <span className="hover:text-[#0A427A] text-orange-500">{filteredClubs.length}</span>
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  ...
                  <SignedIn>
                    <button
                      disabled={isLoading || savedFavorites.includes(club._id!)}
                  ...
                  <RegisterLoginAlertDialog showLoginAlert={showLoginAlert} setShowLoginAlert={setShowLoginAlert} id={club._id!} message={'Дугуйланг хадгалахын тулд эхлээд нэвтрэх шаардлагатай.'} />
                </div>
                <div className="flex justify-between items-center">

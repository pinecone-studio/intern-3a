    ...
    <div className="max-w-7xl mx-auto px-4 py-4 md:py-10">
      <div className="flex flex-col lg:flex-row gap-6 lg:gap-10 items-start">
        ...
        <div className="w-full lg:w-[55%] space-y-6 lg:sticky lg:top-6">
          <div className="bg-white rounded-[2rem] md:rounded-[2.75rem] border border-slate-100 p-5 md:p-8 shadow-xl shadow-slate-200/40 space-y-8 md:space-y-10">
            {/* ТҮВШИН СОНГОХ */}
            <div>
            ...
            {/* ҮНЭ */}
            <div className="bg-slate-50 rounded-[1.5rem] md:rounded-3xl p-5 md:p-6 border border-slate-100 flex flex-row items-center justify-between gap-4">
              <div className="min-w-0">
